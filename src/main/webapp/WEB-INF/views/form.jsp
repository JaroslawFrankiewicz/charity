...
<%--                        <input type="number" name="bags" step="1" min="1" />--%>
        ...
        <div data-step="3">
            ...
            <c:forEach items="${institutions}" var="institution">
                <div class="form-group form-group--checkbox">
                    <label>
                        <input type="radio" name="institution" value="${institution.id}" id="institution" stringValue2="${institution.name}" />
                        <span class="checkbox radio" path="institution"></span>
                        <span class="description" path="institution">
                ...
                <div class="summary">
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="summary--text" id="quantityInput"></span><br>
                                <span class="summary--text" id="categoryInput"></span>
                            </li>

                            <li>
                                <span class="icon icon-hand"></span>
                                <span class="summary--text" id="institutionInput"></span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="form-section form-section--columns">
                        <div class="form-section--column">
                            <h4>Adres odbioru:</h4>
                            <ul>
                                <li id="streetInput"></li>
                                <li id="cityInput"></li>
                                <li id="zipCodeInput"></li>
<%--                                <li>123 456 789</li>--%>
                            </ul>
                        </div>
